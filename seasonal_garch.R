...
library(fGarch)
library(forecast)
sp500 = read.csv("/Users/deepikavasukumar/Documents/Stevens/MA 641/project/dow_jones.csv")
##the daily values of NASDAQ Composite over the period from Jan 1st, 2005 to Jan 1st, 2015. 
spprice=sp500$M1109BUSM293NNBR ##take use of the adjusted close price
spprice
...
arima211=arima(spreturn,order=c(0,2,0))
summary(arima211)
AIC(arima211)
BIC(arima211)
##
...
plot(squared.res.argar,main='Squared Residuals',ylab="squared residuals ARIMA/GARCH")
